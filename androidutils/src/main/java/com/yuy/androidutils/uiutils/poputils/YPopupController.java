package com.yuy.androidutils.uiutils.poputils;
...
public class YPopupController {
    ...
    YPopupController(Context context, PopupWindow popupWindow) {
    ...
    static class PopupParams {
        ...
        public void apply(YPopupController controller) {
            if (mView != null) {
